...
import { updateTitle, updateFavicon, formatTime, notify, requestNotifications } from './ui.js';
...
async function handleSubmit(query) {
  ...
  try {
    for await (const chunk of createAgent(query)) {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  window.formElements = Form.init(handleSubmit);
